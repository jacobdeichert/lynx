...
namespace lynx {
	...
	public:
		...
		void setup(int windowWidth, int windowHeight, std::string windowName, std::string logFilename = "LynxGame", bool isFullscreen = false);
		void shutdown();
		...
		virtual void onMouseButtonPressed(MouseButtonEvent mouse) {}				///< A mouse button was pressed (data in event.mouseButton)
		virtual void onMouseButtonReleased(MouseButtonEvent mouse) {}				///< A mouse button was released (data in event.mouseButton)
