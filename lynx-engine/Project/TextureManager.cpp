...
void TextureManager::load(std::string _textureFilePath) {
...
Texture* TextureManager::get(std::string _textureFilePath) {
	if (loadedTextures.find(_textureFilePath) == loadedTextures.end()) {
		load(_textureFilePath);
	}
	return loadedTextures[_textureFilePath];
}
