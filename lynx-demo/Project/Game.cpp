...
void Game::init() {
	...
	cube1->addComponent(new Graphics(cube1, Resources::getMesh("models/cube_1_face.ply"), Resources::getShader("toon"), Resources::getTexture("textures/tron.png")));
	...
	cube3->addComponent(new Graphics(cube3, Resources::getMesh("models/cube_1_face.ply"), Resources::getShader("toon"), Resources::getTexture("textures/circle.png")));
	...
	monkey->addComponent(new Graphics(monkey, Resources::getMesh("models/monkey.ply"), Resources::getShader("toon"), Resources::getTexture("textures/tron.png")));
	...
	gun->addComponent(new Graphics(gun, Resources::getMesh("models/gun.ply"), Resources::getShader("toon"), Resources::getTexture("textures/gun-1.png")));
	gun->transform->setPosition(0, 20, 0);
	scene->add(gun);
	// add mag to gun
	GameObject *mag = new GameObject("mag");
	mag->addComponent(new Graphics(mag, Resources::getMesh("models/mag.ply"), Resources::getShader("toon"), Resources::getTexture("textures/mag-1.png")));
	gun->transform->addChild(mag->transform);


	sphere1 = new GameObject("sphere1");
	sphere1->addComponent(new Graphics(sphere1, Resources::getMesh("models/sphere.ply"), Resources::getShader("toon"), Resources::getTexture("textures/purpleBall.png")));
	...
	sphere2->addComponent(new Graphics(sphere2, Resources::getMesh("models/sphere.ply"), Resources::getShader("toon"), Resources::getTexture("textures/tron.png")));
